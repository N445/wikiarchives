...
//            elseif ($catalogNextId = $request->get('catalogNextId')) {
//                if ($catalogNext = $this->catalogRepository->byIdAdmin($catalogNextId)) {
//                    $this->catalogRepository->persistAsPrevSiblingOf($directory, $catalogNext);
//                }
//            }
